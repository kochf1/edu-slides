...
\begin{document}
    ...
    \slideImageText{slideImageText}{tests/img-1.png}{\input{tests/text-1.txt}}
    ...
    \slideConcept{slideConcept}{Concept}{\input{tests/text-1.txt}}
    \slideConceptTwo{slideConceptTwo}{Concept 1}{\input{tests/text-1.txt}}{Concept 2}{\input{tests/text-1.txt}}
    \slideConceptThree{slideConceptThree}{Concept 1}{Explanation text}{Concept 2}{Explanation text}{Concept 3}{Explanation text}
    \slideConceptFour{slideConceptFour}{Concept 1}{Explanation text}{Concept 2}{Explanation text}{Concept 3}{Explanation text}{Concept 4}{Explanation text}
