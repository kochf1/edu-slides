...
\begin{document}
    ...
    %% Open the Slide Deck
    \slideCover[title=Lesson 1 \\ Introductions]
    ...
    \slideImage[title=slideImage, image=img-1]
    \slideDoubleImage[title=slideDoubleImage, image/1=img-1, image/2=img-1]
    %\slideBigImage[image=img-1]

    %%
    %% QUOTE templates
    \slideQuote[title=Some Other Templates to Explore]
    \slideQuoteText[title=The centrality of interactions]{!text-1}
    \slideQuoteText[type=diagram, title=The centrality of interactions]{!tree-1}
    \slideTextQuote[type=diagram, title=The centrality of interactions]{!tree-1}
